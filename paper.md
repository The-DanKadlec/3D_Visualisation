...
In contrast, ground reaction force is ontologically a vector quantity, defined by magnitude and direction in three-dimensional space [@Winter2009]. Preserving that three dimensional structure in the visualisation reveals how changes in amplitude and orientation co-occur throughout a given time domain. By integrating 3D vector waveforms, Pedotti plots, and polar coordinate visualisations, `shinyForce3D` provides users with a richer and more coherent understanding of the emergence of ground reaction force.
